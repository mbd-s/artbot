...
ActiveRecord::Schema.define(version: 20160517070528) do
  ...
  add_index "questions", ["art_id"], name: "index_questions_on_art_id", using: :btree

  add_foreign_key "arts", "artists"
  add_foreign_key "questions", "arts"
end
